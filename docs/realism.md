...
New packages show a nightly hotel rate and an early-exit-to-final trip estimate. Booking pays for arrival, preparation and the entry-round night. Reaching later rounds adds only the extra nights needed, with dated charges in the finance ledger and updated event travel costs. Round dates are estimated across the event's configured duration; several rounds on the same day share one hotel night. Rates and paid-through dates persist across saves. Older packages that already prepaid the full event remain covered without additional round charges. Original routes and nightly rates remain fixed once travel starts. Players remain at the event location afterwards, allowing direct onward travel. Return-home travel costs money and occupies the timetable.
