...
export type TableSetup = {
  ...
  tier: 'Budget' | 'Entry' | 'Mid-Tier' | 'High Performance' | 'Elite' | 'Championship'
  clothSpeed: number
...
export type Tournament = {
  id: string
  name: string
  type: 'Junior' | 'Regional Youth' | 'National Youth' | 'Amateur' | 'Q Tour' | 'Q School' | 'Professional Tour' | 'Ranking' | 'Major' | 'Invitational' | 'Exhibition' | 'Senior'
  formatId?: string
  stageId?: number
  pathwayTier?: string
  tourCircuit?: string
  month?: string
  week?: number
  eventClass?: 'Junior' | 'Regional Youth' | 'National Youth' | 'Amateur' | 'Q Tour' | 'Q School' | 'Professional' | 'Major' | 'Invitational' | 'Exhibition' | 'Senior'
  location: string
  startDate: string
  endDate?: string
  entryFee: number
  ...
  rankingType?: 'None' | 'Youth' | 'Amateur' | 'Q Tour' | 'Q School OOM' | 'World Ranking' | 'One-Year' | 'Senior'
  rankingValue: number
  prestige?: 1 | 2 | 3 | 4 | 5
...
export type TrainingCell = {
  title: string
  subtitle: string
  category: 'Technical' | 'Mental' | 'Physical' | 'Match Prep' | 'Recovery' | 'Travel' | 'Rest'
}
...
export type TrainingPlannerSummary = {
  ...
  balance: { label: string; value: number; sessions: number; tone: 'green' | 'violet' | 'blue' | 'gold' }[]
...
export type CueTag = 'Best Value' | 'Tournament Grade' | 'High Precision' | 'One-Piece'
...
export type CalendarEventDetail = {
  ...
  alertTitle: string
  alertText: string
  decisionImpact: { label: string; value: string; tone: 'green' | 'amber' | 'red' }[]
  progressMeters: { label: string; value: number; max: number; detail: string; tone: 'green' | 'amber' | 'red' | 'blue' }[]
}
